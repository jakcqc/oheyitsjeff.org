...
registerVisual("bacterialConstructs", {
  ...
  params: [
    ...
    { key: "feed", label: "feed F", type: "number", default: 0.0545, category: "Equation", min: 0.01, max: 0.09, step: 0.0001, description: "Gray-Scott replenishment rate." },
    { key: "kill", label: "kill k", type: "number", default: 0.062, category: "Equation", min: 0.03, max: 0.08, step: 0.0001, description: "Gray-Scott removal rate." },
    { key: "diffusionA", label: "cell / U diffusion", type: "number", default: 0.16, category: "Equation", min: 0.01, max: 1, step: 0.01 },
    { key: "diffusionB", label: "signal / V diffusion", type: "number", default: 0.08, category: "Equation", min: 0.01, max: 1, step: 0.01 },
    { key: "chemotaxis", label: "chemotactic pull", type: "number", default: 0.62, category: "Equation", min: 0, max: 1.5, step: 0.01 },
    { key: "growth", label: "logistic growth", type: "number", default: 0.19, category: "Equation", min: 0, max: 0.5, step: 0.005 },
    ...
    { key: "markDensity", label: "cell mark density", type: "number", default: 0.15, category: "SVG Styling", min: 0.01, max: 0.5, step: 0.01 },
