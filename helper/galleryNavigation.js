...
import './galleryFooter.js';

// Gallery routes open their bubbles even when mobile previously showed Apps.
document.querySelectorAll('#headerActions [data-gallery-link]').forEach(link => {
  link.addEventListener('click', () => {
    try { localStorage.setItem('home.mobileMode', 'bubbles'); } catch {}
  });
});
